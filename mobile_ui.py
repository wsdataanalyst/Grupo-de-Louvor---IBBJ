...
def mobile_first_css() -> str:
    return f"""
        ...
        @media (max-width: {MOBILE_MAX_PX}px) {{
            ...
            body:has(#ml-chat-active) [class*="st-key-ml_chat_compose_main"] [data-testid="stHorizontalBlock"] {{
                flex-wrap: nowrap !important;
            }}
            body:has(#ml-chat-active) [class*="st-key-ml_chat_compose_main"] [data-testid="stHorizontalBlock"] > [data-testid="stColumn"] {{
                flex: 0 0 auto !important;
                width: auto !important;
                max-width: none !important;
            }}
            body:has(#ml-chat-active) [class*="st-key-ml_chat_compose_main"] [data-testid="stHorizontalBlock"] > [data-testid="stColumn"]:nth-child(3) {{
            ...
            body:has(#ml-chat-active) [data-testid="element-container"] {{
