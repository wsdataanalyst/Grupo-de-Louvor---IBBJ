...
STATIC_MOBILE_LAB_THEME_HREF = "/static/mobile_lab_theme.css"
_STATIC_MOBILE_LAB_CSS_PATH = Path("static") / "mobile_lab_theme.css"
...
def inject_mobile_lab_theme() -> None:
    ...
    css_key = "_mobile_lab_css_blob_v5"
...
def _open_escala_in_app(*, escala_id: str, tab: str = "visao") -> None:
            ...
            with hb1:
                with st.container(key="ml_dash_escala_app"):
                    if st.button(
                        ...
                        _open_escala_in_app(escala_id=eid, tab="visao")
                        st.rerun()
            with hb2:
